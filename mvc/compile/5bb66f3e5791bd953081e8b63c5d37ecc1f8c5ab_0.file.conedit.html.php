<?php
/* Smarty version 3.1.30, created on 2017-09-17 08:44:06
  from "D:\wamp\wamp\www\PHP\0911\mvc\template\admin\conedit.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59be19b621b241_36193971',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5bb66f3e5791bd953081e8b63c5d37ecc1f8c5ab' => 
    array (
      0 => 'D:\\wamp\\wamp\\www\\PHP\\0911\\mvc\\template\\admin\\conedit.html',
      1 => 1505630637,
      2 => 'file',
    ),
  ),
...
function content_59be19b621b241_36193971 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
?>
            <?php if ($_smarty_tpl->tpl_vars['v']->value['id'] == $_smarty_tpl->tpl_vars['data']->value['catid']) {?>
...
?>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['title'];?>
" name="title" data-validate="required:请输入标题" />
      ...
      <div class="form-group">
        ...
        <div class="field">
          ...
          <input type="hidden" id="hidden" name="hidden" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['thumb'];?>
">
...
foreach ($_from as $_smarty_tpl->tpl_vars['v']->value) {
?>
          <?php if ($_smarty_tpl->tpl_vars['v']->value['id'] == $_smarty_tpl->tpl_vars['data']->value['posid']) {?>
          <input type="radio" value="<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" name="posid" checked><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
...
?>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <textarea class="input" name="description" style=" height:90px;"><?php echo $_smarty_tpl->tpl_vars['data']->value['description'];?>
</textarea>
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <textarea name="content1" class="input" style="height:450px; border:1px solid #ddd;"><?php echo $_smarty_tpl->tpl_vars['data']->value['content'];?>
</textarea>
          <div class="tips"></div>
        </div>
      </div>
...
>
          <input type="date" class="laydate-icon input w50" name="datetime" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['time'];?>
"  data-validate="required:日期不能为空" style="padding:10px!important; height:auto!important;border:1px solid #ddd!important;" />
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="source" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['source'];?>
"  />
          <div class="tips"></div>
        </div>
      </div>
